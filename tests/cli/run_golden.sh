...
run_case "cast_error_redundant" "run" 65 "" $'2:11: error: Redundant cast: source and target are both Int.\n'
run_case "cast_error_missing_else" "run" 65 "" $'2:11: error: Cast from String to Int may fail; provide an \'else\' clause.\n'
run_case "cast_error_unneeded_else" "run" 65 "" $'2:11: error: \'else\' clause is not allowed: Float to Int never fails.\n'
